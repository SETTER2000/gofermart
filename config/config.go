...
func NewConfig() (*Config, error) {
	...
	// flags
	flag.StringVar(&cfg.HTTP.ServerAddress, "a", "localhost:8088", "host to listen on")
	flag.StringVar(&cfg.HTTP.Accrual, "r", "localhost:8087", "host to listen on")
	flag.StringVar(&cfg.HTTP.BaseURL, "b", "http://localhost:8088", "the base address of the resulting shortened URL")
