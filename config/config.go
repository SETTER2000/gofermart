...
func NewConfig() (*Config, error) {
	...
	flag.StringVar(&cfg.HTTP.Accrual, "r", "localhost:8088", "host to listen on")
	...
	flag.StringVar(&cfg.Storage.ConnectDB, "d", "postgres://gofermart:DB_gf-2023@localhost:5432/gofermart?sslmode=disable", "dsn connect string urlExample PostgreSQL: postgres://username:password@localhost:5432/database_name")
